...
lims_diff <- list(mean        = c(-1000, -30, -20, -10, -5, 0, 5, 10, 20, 30, 1000),
                  variability = c(-10000, -30, -20, -10, -5, 0, 5, 10, 20, 30, 10000),
                  CV          = c(-100, -10, -8, -6 , -4, -2, 0 , 2, 4, 6, 8, 10, 100))


unit <- c(mean        = "mm/month", 
...
plot_data_dir <- paste0(path, "/Plot_data_mean_variability/")
...
for (m in 1:length(metrics)) {
  ...
  png(paste0(outdir, "/FigureX", "_weighted_mean_all_datasets_in_", metrics[m], "_",
      ...
      height=6, width=8.3, units="in", res=400)
