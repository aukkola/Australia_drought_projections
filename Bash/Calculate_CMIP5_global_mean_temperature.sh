...
#output path
outdir=$path'/Global_mean_temp/CMIP5/'
...
do
  ...
  #List models
  models=`ls $path"/CMIP5_data/Processed_CMIP5_data/"$exp"/tas/"`
  ...
  do
    ...
    #List ensembles
    ensembles=`ls $path"/CMIP5_data/Processed_CMIP5_data/"$exp"/tas/"$mod`
    
    for ens in $ensembles
    do
      
      #Find file
      file=`ls ${path}/CMIP5_data/Processed_CMIP5_data/${exp}/tas/${mod}/${ens}/*_Aus.nc`
