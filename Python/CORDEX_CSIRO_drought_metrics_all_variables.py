...
#CSIRO data location
in_path="/g/data/hq89/CCAM/output/CMIP6/DD/AUS-10i/CSIRO/"
...
temp_dir = str(scratch_path + "/monthly_sums_CORDEX_CSIRO/")
            ...
            for e in range(len(ensemble)):
                ...
                for v in range(len(var_name)):
                    ...
                    files = glob.glob(in_path +  "/" + models[m] + "/" + experiment[k] + "/" +
                               ensemble[e] + "/CCAM-v2203-SN/v1-r1/mon/" + var_name[v] + "/v20231206/*.nc")
                    ...
                    if not os.path.isfile(temp_file):
                        ...
                        if var_name[v] == "pr":
                            ...
                            mrro_file = files = glob.glob(in_path +  "/" + models[m] + "/" + experiment[k] + "/" +
                                       ensemble[e] + "/CCAM-v2203-SN/v1-r1/mon/mrro/v20231206/*.nc")
                    ...
                    #Creat output path
                    out_path = (root_path + '/Drought_metrics/CORDEX_CSIRO/' + experiment[k] + "/" + 
