...
#Qld CORDEX data location
in_path="/g/data/ig45/QldFCP-2/CORDEX/CMIP6/DD/AUS-20i/UQ-DES/"
...
experiment=['historical', 'ssp126', 'ssp245', 'ssp370'] 
...
temp_dir = str(scratch_path + "/monthly_sums_CORDEX_Qld/")
        ...
        for k in range(len(experiment)):
            ...
            for e in range(len(ensemble)):
                ...
                for v in range(len(var_name)):
                    ...
                    ### Find CORDEX Qld files ###
                    
                    #CCAM has versions CCAMoc-v2112, CCAM-v2112 and CCAM-v2105
                    #depending on the forcing model. Not sure what the difference
                    #is at this stage. Picking CCAM-x depending on what is available
                    #for that model
                    
                    #List files
                    files = glob.glob(in_path +  "/" + models[m] + "/" + experiment[k] + "/" +
                               ensemble[e] + "/CCAM-v*/v1-r1/mon/" + var_name[v] + "/v20231215/*.nc")
                    ...
                    if not os.path.isfile(temp_file):
                        ...
                        if var_name[v] == "pr":
                            ...
                            mrro_file = files = glob.glob(in_path +  "/" + models[m] + "/" + experiment[k] + "/" +
                                       ensemble[e] + "/CCAM-v*/v1-r1/mon/mrro/v20231215/*.nc")
                    ...
                    #Creat output path
                    out_path = (root_path + '/Drought_metrics/CORDEX_Qld/' + experiment[k] + "/" + 
