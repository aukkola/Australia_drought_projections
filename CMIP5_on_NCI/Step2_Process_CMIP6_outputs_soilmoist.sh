...
DIR="/g/data/w97/amu561/CABLE_AWRA_comparison/CMIP6_data"
...
search_criteria="--local $dataset --experiment historical --experiment ssp245 \
	       	 ...
	       	 --experiment ssp460 --variable mrsol \ 
                 --table Emon"
...
in_file=$TEMP_DIR/"${dataset}_clef_search_results_soilmoist.csv"
...
do
    ...
    vars="${IN_DIR}/${E}/Emon/mrsol" #`find ${IN_DIR}/${E} -maxdepth 2 -mindepth 2 ! -path . -type d`
